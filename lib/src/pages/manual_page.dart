    ...
    final sections = <({IconData icon, String title, List<String> content})>[
      ...
      (
        ...
        content: [
          ...
          "Update Radio Position controls whether your GPS coordinates get written back to the radio during scans.",
          "Tile Caching saves map tiles for offline use. You can download all tiles for your current area or clear cached tiles.",
      ...
      (
        ...
        content: [
          ...
          "The header bar shows your connection status: an orange badge for offline, blue for items waiting to sync.",
      ...
      (
        ...
        content: [
          ...
          "On Android, tap the browser menu and choose Install app. On iOS (in Bluefy), use Add to Home Screen. On desktop Chrome/Edge, click the install icon in the address bar.",
      ...
      (
        ...
        content: [
          ...
          "Connection drops on iOS: Bluetooth can disconnect when app sleeps/backgrounds; return to app and reconnect if prompted.",
        ],
      ),
    ];
